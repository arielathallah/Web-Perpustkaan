...
// Jika member sudah login, arahkan langsung ke dashboard
...
if(isset($_POST["signIn"])) { // Sama dengan name tombol
    $nisn = $_POST["nisn"];
    ...
    if(mysqli_num_rows($result) === 1) {
        ...
        if(password_verify($password, $pw["password"])) {
            ...
            $_SESSION["member"]["nama"] = $pw["nama"]; // Pastikan nama ada di sini
