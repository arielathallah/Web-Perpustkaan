    ...
    $dataDenda = queryReadData("SELECT pengembalian.id_pengembalian, pengembalian.id_buku, buku.judul, pengembalian.nisn, member.nama, member.jurusan, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
    FROM pengembalian
