...
(1, 'admin1', '123', 'admin', '089652935248'),
(2, 'bambang subroto', '1234', 'admin1', '085749051409'),
(3, 'esti sitanggang', '4321', 'admin2', '085870283409');
...
(2005, '10', 'ariel', '$2y$10$peZYMWij6VTLgB7/Cn9y7.MGdROF5XhTtu6ixKTfvUlqZ/xzknxQO', 'Laki laki', 'XI', 'Desain Komunikasi Visual', '11', '2024-09-03'),
(2024, '3', 'user1', '$2y$10$c3Fc6k22Tcpnl5TdCuAgcOUjuG0saCWAP4b585WdQ2w6gYLgDRNyC', 'Perempuan', 'X', 'Teknik Instalasi Tenaga Listrik', '0000', '2334-04-23'),
(2025, '5', 'user1', '$2y$10$7DKF6hPOcbgnc.XqJ8eHUeDQQbTUS.sC5CKcdoSJFC.Hc0o6i8.4.', 'Perempuan', 'X', 'Rekayasa Perangkat Lunak', '000', '1111-11-11'),
(2147483647, '1', 'ariel athallah', '$2y$10$mfbW42OVPmSGtxiAW2PR3ubfjjS/h8T8oPUZnr/GDT5H3lq0CZzfS', 'Laki laki', 'XI', 'Sistem Informatika Jaringan dan Aplikasi', '00000', '2004-12-11');
