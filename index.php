    ...
    <div class="container-fluid">
        <a href="index.css">
        <img src="assets/p.png" alt="logo" width="120px" class="logo-animated">
        <a href="sign_in/link_login.html" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <!--Untuk bagian Paragraf-->
        <section id="homeSection" class="p-5">
        <div class="d-flex flex-wrap justify-content-center">
            <div class="col mt-5">
            <h2 class="fw-bold text-success"><span class="text-primary">Riel</span>Books</h2>
            <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">RielBooks</span> Membawa Anda ke Dunia Buku Digital."</p>
            <a class="btn btn-primary" href="sign_in/link_login.html">Get started</a>
            </div>
            <div class="col mt-3">
        ...
        <div class="card border-info mb-3" style="max-width: 18rem;">
            <div class="card-header">Universitas Esa Unggul</div>
            <div class="card-body">
            <h5 class="card-title">Student At Ilmu Komputer</h5>
            </div>
        </div>
        </div>
        </section>
        ...
        <div class="row">
            <div class="col">
            <img src="assets/footer.png" width="300px">
            </div>
        </div>
        <div class="row p-3">
            <div class="col mt-3">
            <h3 class="text-light fs-5">Alamat</h3>
            <p class="text-secondary fs-6">Jl. Arjuna Utara 9A, Duri Kepa, Kebon Jeruk
            Jakarta Barat
            11510</p>
            </div>
            ...
            <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Esa Unggul</a>  2024</p>
            </div>
        </div>
        </footer>
