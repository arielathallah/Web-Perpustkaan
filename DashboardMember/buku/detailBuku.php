    ...
    if ($query === false) {
        die("Terjadi kesalahan saat mengambil data buku: " . mysqli_error($koneksi)); // Ganti $koneksi dengan variabel koneksi database yang benar
    }
    ?>
    ...
    <img src="../../img/<?= $item["cover"]; ?>" class="card-img-top" alt="coverBuku" height="400px">
    <div class="card-body">
    ...
    <div class="card-body">
        ...
        <a href="../../DashBoardMember/formPeminjaman/pinjamBuku.php ?id=<?= $item["id_buku"]; ?>" class="btn btn-success">Pinjam</a>
        </div>
        </div>
    </div>
    </div>
