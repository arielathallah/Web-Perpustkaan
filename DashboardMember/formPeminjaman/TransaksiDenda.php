    ...
    $dataDenda = queryReadData("SELECT pengembalian.id_pengembalian, pengembalian.id_peminjaman, pengembalian.id_buku, buku.judul, pengembalian.nisn, member.nama, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
    FROM pengembalian
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-success btn-sm" href="formBayarDenda.php?id=<?= htmlspecialchars($item["id_pengembalian"]); ?>">Bayar</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
