...
<body>
    ...
    <div class="mt-5 p-4">
        ...
        $day = $dayNames[date('w')]; // Mendapatkan nama hari
        $dayOfMonth = date('d');
        $monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        $month = $monthNames[date('n') - 1]; // Mendapatkan nama bulan
        $year = date('Y');
        ?>
        ...
        <div class="alert alert-success" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?></span> di Dashboard RielBooks</div>
        ...
        <div class="mt-3 p-3">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-2">
                <div class="cardImg">
                    <a href="../DashboardMember/buku/daftarBuku.php">
                        <img src="../assets/Kartu_member/daftarBuku.png" alt="daftar buku" style="max-width: 100%;" width="450px">
                    </a>
                </div>
                <div class="cardImg">
                    <a href="../DashboardMember/formPeminjaman/TransaksiPeminjaman.php">
                        <img src="../assets/Kartu_member/peminjaman.png" alt="peminjaman" style="max-width: 100%;" width="450px">
                    </a>
                </div>
                <div class="cardImg">
                    <a href="../DashboardMember/formPeminjaman/TransaksiPengembalian.php">
                        <img src="../assets/Kartu_member/pengembalian.png" alt="pengembalian" style="max-width: 100%;" width="450px">
                    </a>
                </div>
                <div class="cardImg">
                    <a href="../DashboardMember/formPeminjaman/TransaksiDenda.php">
                        <img src="../assets/Kartu_member/denda.png" alt="denda" style="max-width: 100%;" width="450px">
                    </a>
                </div>
            </div>
        </div>
